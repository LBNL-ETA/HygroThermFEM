...
SquareMatrix::SquareMatrix(const std::size_t m_size)
    : m_size(m_size), m_Matrix(m_size, m_size) {}

SquareMatrix::SquareMatrix(
    const std::size_t tSize,
    const std::vector<Eigen::Triplet<double>> &tripletList)
    : m_size(tSize), m_Matrix(m_size, m_size) {
...
void SquareMatrix::setZeros() { m_Matrix.setZero(); }

void SquareMatrix::setIdentity() { m_Matrix.setIdentity(); }
...
SquareMatrix::SquareMatrix(Eigen::SparseMatrix<double> &&tMatrix)
    : m_size(tMatrix.innerSize()), m_Matrix(tMatrix) {}
...
double SquareMatrix::operator()(const std::size_t i,
...
std::vector<double> SquareMatrix::
operator*(const std::vector<double> &tVec) const {
