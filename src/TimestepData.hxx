...
namespace Timesteps
{
    ...
    public:
        ...
        //! \brief Sets maximum number of timestep subdivisions
        //!
        //! If engine fails to converge, it will first try to divide current timestep into number of
        //! smaller segments. It will keep doing that till maximum number of divisions has been
        //! reached.
        //! \param maxDivisions - maximum allowed number of subdivisions
        void setMaxDivisions(unsigned maxDivisions);
        ...
        //! \brief Sets number of sub-timesteps that program will divide current timestep into in
        //! case of convergence failure.
        //!
        //! \param numberOfSubtimesteps - Number of sub-timesteps that program will divide current timestep into.
        void setNumberOfSubtimesteps(unsigned numberOfSubtimesteps);
