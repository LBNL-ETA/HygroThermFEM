...
namespace HygroThermFEM::Moisture
{
                         ...
                         double surfaceTilt)
    {
        ...
        auto & Material = domain.elements.findElement(index1, index2)->getMaterial();
        domain.boundaryConditions.assignBC(std::make_unique<MoistureBCTARPHc>(
                         ...
                         double surfaceTilt)
    {
        ...
        const auto & Material = domain.elements.findElement(index1, index2)->getMaterial();
    ...
    {
        const auto & Material = domain.elements.findElement(index1, index2)->getMaterial();
        domain.boundaryConditions.assignBC(std::make_unique<MoistureBCASHRAEInside>(
                          ...
                          const FixedBCHCCoefficients & fixedBchcCoefficients)
    {
        /// Need to pull material for current moisture boundary condition
        auto & Material = domain.elements.findElement(index1, index2)->getMaterial();
        domain.boundaryConditions.assignBC(std::make_unique<MoistureBCFixedHc>(
