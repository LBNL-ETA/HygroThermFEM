...
namespace MoisThermFEM {
	...
	void MultiDomain::createConvectionBC( const Node2D & t_Node1, const Node2D & t_Node2,
		...
		m_ThermalDomain.createConvectionBC( t_Node1, t_Node2, t_ConvectionCoefficient,
																				t_AirTemperature );

		m_MoistureDomain.createMoistureBC( t_Node1, t_Node2, t_ConvectionCoefficient, t_Humidity,
																			 t_AirTemperature );
	}
	...
	void MultiDomain::createBlackBodyRadiationBC( const Node2D & t_Node1, const Node2D & t_Node2,
		...
		m_ThermalDomain.createBlackBodyRadiationBC( t_Node1, t_Node2, t_Emissivity,
