...
namespace MoisThermFEM {
	...
	IBCLinear2D::IBCLinear2D( const Node2D & t_Node1, const Node2D & t_Node2,
																const bool t_Nonlinear )
			: m_Nodes( t_Node1, t_Node2 ), m_Nonlinear( t_Nonlinear ), m_PsiVector( numOfNodes, 0 ),
				m_PsiPsiMatrix( numOfNodes ){
	...
	bool IBCLinear2D::isNonlinear() const {
		return m_Nonlinear;
	}
