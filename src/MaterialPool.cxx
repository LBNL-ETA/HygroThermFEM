...
namespace MoisThermFEM {
	...
	const Material &
	MaterialPool::createMaterial(
			const std::string & Name, double Density, double Porosity,
			double HeatCapacity, double ThermalConductivity,
		...
		m_Materials.emplace(
				std::make_pair( Name, Material( Name, Density, Porosity, HeatCapacity, ThermalConductivity,
																				DiffusionResistanceFactor, LiquidTransportCurve,
																				SorptionCurve ) ) );
