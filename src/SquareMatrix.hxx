...
namespace FenestrationCommon
{
    ...
    public:
		...
		// Constructor with triplets should be used for huge matrices. For example 100,000 x 100,000 will not fit
		// into memory of vector<vector<double>>
		explicit SquareMatrix(const std::size_t m_size, const std::vector<Eigen::Triplet<double>> & tripletList);
