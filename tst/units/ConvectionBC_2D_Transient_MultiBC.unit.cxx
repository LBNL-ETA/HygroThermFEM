...
TEST_F(ConvectionBC_2D_Transient_MultiBC, TestExample_1)
{
    ...
    HygroThermFEM::Thermal::createBC_FixedHc(domain, 1, 2, bcCoeffsTransient);
    ...
    {
        temperatures = HygroThermFEM::Substitution::transient(domain, temperatures, dTime, timestepIndex).solution;
