...
TEST_F(TestLinearSolver3, Test1)
{
    ...
    const SparceSquareMatrix<double> aMatrix{{67, 34, 0, 0, 0, 0, 0, 0, 0, 0},
                                       {0, 69, 24, 0, 0, 0, 0, 0, 0, 0},
                                       {58, 62, 64, 5, 0, 0, 0, 0, 0, 0},
                                       {0, 81, 27, 61, 91, 0, 0, 0, 0, 0},
                                       {0, 0, 42, 27, 36, 91, 0, 0, 0, 0},
                                       {0, 0, 0, 2, 53, 92, 82, 0, 0, 0},
                                       {0, 0, 0, 0, 16, 18, 95, 47, 0, 0},
                                       {0, 0, 0, 0, 0, 71, 38, 69, 12, 0},
                                       {0, 0, 0, 0, 0, 0, 99, 35, 94, 3},
                                       {0, 0, 0, 0, 0, 0, 0, 22, 33, 73}};
    std::vector<double> aVector{41, 0, 78, 45, 95, 4, 21, 26, 67, 11};

    auto aSolver = GetSolver();

    std::vector<double> correctSolution{0.686075496,
                                        -0.146089948,
                                        0.420008601,
                                        4.076929511,
                                        -2.232963149,
