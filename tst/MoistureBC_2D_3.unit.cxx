...
TEST_F(MoistureBC_2D_3, TestExample_1)
{
	...
	auto & material = MaterialPool::Instance().createMaterial("Cottaer Sandstone",
															  2050,                       /// density
															  0.22,                       /// porosity
	...
	domain.createMoistureBC(1, 2, humidity, airTemperature);
	...
	std::vector<std::vector<double>> correctSolution = {
		{4.56238485, 4.56238485, 0.165365838, 0.165365838, 0.00600161797, 0.00600161797, 0.000434491517, 0.000434491517},
		{5.15447905, 5.15447905, 0.340625261, 0.340625261, 0.0179586848,  0.0179586848,  0.00170316829,  0.00170316829},
		{5.23276638, 5.23276638, 0.506652687, 0.506652687, 0.0351475929,  0.0351475929,  0.00412440184,  0.00412440184},
		{5.24446337, 5.24446337, 0.661869378, 0.661869378, 0.0568487783,  0.0568487783,  0.00794142158,  0.00794142158}};
