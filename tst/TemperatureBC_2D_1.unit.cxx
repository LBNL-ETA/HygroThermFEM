...
TEST_F( TemperatureBC_2D_1, TestExample_1 ) {
	...
	const auto node1 = nodePool.createNode( 1, 15, 5, state );
	const auto node2 = nodePool.createNode( 2, 15, 0, state );
	const auto node3 = nodePool.createNode( 3, 5, 5, state );
	const auto node4 = nodePool.createNode( 4, 5, 0, state );
	auto node5 = nodePool.createNode( 5, 0, 5, state );
