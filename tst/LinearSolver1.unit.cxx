...
TEST_F(TestLinearSolver1, Test1)
{
    ...
    const SparceSquareMatrix<double> aMatrix{{2, 1, 3}, {2, 6, 8}, {6, 8, 18}};
...
TEST_F(TestLinearSolver1, Test2)
{
    ...
    const SparceSquareMatrix<double> aMatrix{{4, 0, 5}, {2, 0, 1}, {1, 8, 0}};
...
TEST_F(TestLinearSolver1, Test3)
{
    ...
    const SparceSquareMatrix<double> aMatrix{{32817.2867004354, 1, 0, -32808.3972386696},
    ...
    std::vector<double> correctSolution{303.040746, 461.535283, 451.057585, 303.040507};
