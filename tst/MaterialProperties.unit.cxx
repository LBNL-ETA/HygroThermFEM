...
TEST_F(MaterialPropertiesUnit, TestMaterialProperties)
{
    ...
    auto iFill = iceFill.value(state1);
	...
	iFill = iceFill.value(state4);

	EXPECT_NEAR(0.213522, aFill, 1e-6);
	EXPECT_NEAR(0.0, wFill, 1e-6);
	EXPECT_NEAR(0.006478, iFill, 1e-6);
}
